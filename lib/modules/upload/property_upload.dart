  ...
  Widget _buildMapSection(ColorScheme colorScheme) {
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            // Wrap GoogleMap with Listener for gesture control
            Listener(
              ...
              child: Container(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    final newPosition = LatLng(37.4223, -122.0848);
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Tap on the map to set the property location or drag the marker',
                        style: TextStyle(
                          fontSize: 12,
